...
(function () {
  ...
  Odometer = (function () {
    ...
    Odometer.prototype.update = function (newValue) {
      ...
      removeClass(
        this.el,
        "odometer-animating-up odoUp odometer-animating-down odoDown odometer-animating"
      );
      if (diff > 0) {
        addClass(this.el, "odometer-animating-up odoUp");
      } else {
        addClass(this.el, "odometer-animating-down odoDown");
      }
      this.stopWatchingMutations();
